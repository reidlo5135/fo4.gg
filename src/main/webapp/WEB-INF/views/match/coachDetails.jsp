    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-9 text-center">
                ...
                <img class="heading" src="${userList.get(0).coachImageUrl}" alt="coachDivision-img" data-aos="fade-up" />
                ...
                <h1 class="heading" data-aos="fade-up">최고 등급 : ${userList.get(0).coachDivisionName}</h1>
                <h1 class="heading" data-aos="fade-up">달성 일자 : ${userList.get(0).coachAchievementDate}</h1>
            </div>
